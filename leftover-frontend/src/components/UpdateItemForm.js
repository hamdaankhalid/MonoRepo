...
export default function UpdateItemForm(props){
    ...
    const handleSubmit = (event) => {
        ...
        axios.patch(
          `http://127.0.0.1:3000/item/${props.itemId}`, 
          {
              item: {
